...
-- =============================================================================
-- Note: Comments and Analytics are handled by Interaction Service
-- =============================================================================
-- Comments, likes, views, shares, and other interactions are managed by
-- the dedicated Interaction Service to avoid duplication across microservices
...
-- Note: Comment and Analytics indexes are handled by Interaction Service
